...
function FAQs() {
  return (
    <div className="faqs">
        <section className="col16 -pvs">
            <div className="card -phm -fs12">
                <div className="markup -pvs">
                    ...
                    <p>Shop now and enjoy unlimited offers, discounts and the best online shopping experience!<br /><br /></p>
                </div>
            </div>
        </section>

        <div className="b2top">
            <a className="cta btn _fab _sec" href="#top" aria-label="BACK TO TOP">
                <svg aria-hidden="true" viewBox="0 0 24 24" className="ic -f-bk" width="24" height="24">
                    <use xlinkHref="https://www.jumia.com.ng/assets_he/images/i-icons.85419111.svg#arrow-down"></use>
                </svg>
            </a>
        </div>
